...
class BillcomItem(models.Model):
    ...
    short_name = fields.Char(string="Short Name", help="Item short name in Bill.com")
    ...
    description = fields.Text(string="Description", help="Item description")
    ...
    price = fields.Float(string="Price", help="Item price")

    purchase_cost = fields.Float(
        string="Purchase Cost", help="Item purchase cost in accounting system"
    )
    ...
    taxable = fields.Boolean(string="Taxable", help="Set as true if item is taxable")
    ...
    created_time = fields.Datetime(
        string="Created Time", readonly=True, help="Created date/time in Bill.com"
    )

    updated_time = fields.Datetime(
        string="Updated Time", readonly=True, help="Updated date/time in Bill.com"
    )
    ...
    @api.model
    def sync_items_from_billcom(self, item_type=None):
