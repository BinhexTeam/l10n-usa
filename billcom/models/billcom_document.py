...
class BillcomDocument(models.Model):
    ...
    download_link = fields.Char(string="Download Link", readonly=True)
    ...
    def button_upload_to_billcom(self):
        ...
        try:
            ...
            if result:
                ...
                document_id = result.get("id") if result.get("id", "").startswith("00h") else None
                ...
                self.bill_id.message_post(
                    body=f"<p><strong>Bill.com Document Upload {status_msg.title()}</strong></p>"
                    f"<ul>"
                ...
                if vals.get("upload_status") == "in_progress":
                    return {
                        ...
                        "params": {
                            ...
                            "message": _(
                                "Document upload started. Use 'Check Upload Status' to monitor progress."
                            ),
                            "type": "info",
                            "sticky": False,
                        },
                    ...
                    return {
                        ...
                        "params": {
                            ...
                            "message": _("Document uploaded successfully to Bill.com"),
                            "type": "success",
                            "sticky": False,
                        },
                    }
                ...
                if status == "UPLOADED" and document_id:
                    ...
                    if doc_result:
                        self.write({
                            ...
                            "created_time": parse_billcom_datetime(doc_result.get("createdTime")),
                        })
                    ...
                    return {
                        ...
                        "params": {
                            "title": _("Upload In Progress"),
                            "message": _(
                                "Document upload is still in progress. Please check again in a few moments."
                            ),
                            "type": "info",
                            "sticky": False,
                        },
            ...
            if file_data:
                ...
                return {
                    ...
                    "params": {
                        ...
                        "message": _("Document downloaded successfully from Bill.com"),
                        "type": "success",
                        "sticky": False,
                    },
                }
    ...
    def sync_documents_from_billcom(self, bill):
        ...
        try:
            ...
            if synced_count > 0:
                bill.message_post(
                    body=f"<p><strong>Synced {synced_count} document(s) from Bill.com</strong></p>",
                    message_type="notification",
                    subtype_xmlid="mail.mt_note",
                )
